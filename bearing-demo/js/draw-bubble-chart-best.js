...
function bubbleChart() {
  ...
  var yearCenters = {
    Response: { x: width *.3, y: height / 2 },
    Replacement: { x: width * 0.5, y: height / 2 },
    Productivity: { x: width * 0.7, y: height / 2 }
  ...
  var fillColor = d3.scaleOrdinal()
    .domain(['Response', 'Replacement', 'Productivity'])
...
// Load the data.
d3.csv('../../data/loss-amounts-best.csv', display);
